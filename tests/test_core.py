...
class TestSimRacingGames(unittest.TestCase):
    ...
    @patch("offbgamessettings.core._get_steam_path_windows", return_value="C:\\Steam")
    @patch("offbgamessettings.core._get_steam_path_linux", return_value="/home/user/.steam/steam")
    ...
    @patch("offbgamessettings.core.find_steam_path", return_value="/fake/steam")
    ...
    def test_get_sim_racing_game_folders(self, mock_isdir, mock_listdir, mock_open_func, mock_exists, mock_find_steam):
        ...
        mock_open_func.side_effect = [
            ...
            mock_open(read_data=MOCK_APPMANIFEST_244210_ACF).return_value # appmanifest_244210.acf
        ]
        ...
        # Expected result
        expected_folders = {
            "Assetto Corsa": os.path.join("/fake/steam", "steamapps", "common", "assettocorsa")
        }
        ...
        mock_open_func.assert_any_call(os.path.join("/fake/steam", "steamapps", "libraryfolders.vdf"))
        mock_open_func.assert_any_call(os.path.join("/fake/steam", "steamapps", "appmanifest_244210.acf"))
